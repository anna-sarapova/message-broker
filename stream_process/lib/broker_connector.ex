defmodule BrokerConnector do
  ...
  def start_link(port, collection_name) do
    ...
    {:ok, mongo_pid} = Mongo.start_link(url: "mongodb://localhost:27017/Stream_Processor")
    Logger.info("mongo pid #{inspect(mongo_pid)}")
...
#    Logger.info("Message: #{inspect(topic_object)}")
